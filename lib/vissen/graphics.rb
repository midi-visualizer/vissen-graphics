...
require 'vissen/graphics/value'
require 'vissen/graphics/value/real'
require 'vissen/graphics/value/vec'

require 'vissen/graphics/parameterized'
require 'vissen/graphics/parameter'
